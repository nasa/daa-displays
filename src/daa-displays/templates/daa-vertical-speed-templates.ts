export const vspeedTemplate = `<div id="{{id}}-inner" style="overflow:hidden; position:absolute; height:432px; width:60px; top:{{top}}px; left:{{left}}px; opacity:0.8;">
        ...
        <div id="{{id}}-bug" style="position:absolute; left:40px; opacity:0.9; margin-top:1px; z-index:99;">
    ...
    <div id="{{id}}-indicator" style="display:none; position:absolute; opacity:0.9; top:{{top}}px; left:{{left}}px; opacity:0.8;">
        <div id="{{id}}-indicator-box" style="overflow: hidden; position:absolute; background-color:black; border: 2px solid white; width:82px; height:86px; top:452px; left:-2px;">
