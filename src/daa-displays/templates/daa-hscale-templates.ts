...
<div id="{{id}}-carousel-controls" class="carousel slide" style="position:absolute; left:{{left}}px; top:{{top}}px; width:1040px; height:40px; background-color:#333333;">
    <div class="carousel-inner">
        <div class="carousel-item">
            <div style="margin-left:44px; width:960px; height:40px; background-color: #333333;">
                ...
                <div id="{{id}}-radio1-overlay" style="position:absolute; left:40px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio2-overlay" style="position:absolute; left:160px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio3-overlay" style="position:absolute; left:280px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio4-overlay" style="position:absolute; left:400px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio5-overlay" style="position:absolute; left:520px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio6-overlay" style="position:absolute; left:640px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio7-overlay" style="position:absolute; left:760px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio8-overlay" style="position:absolute; left:880px; width:120px; height:40px;">
                </div>
            </div>
        </div>
        <div class="carousel-item active">
            <div style="margin-left:44px; width:960px; height:40px; background-color: #333333;">
                ...
                <div id="{{id}}-radio9-overlay" style="position:absolute; left:40px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio10-overlay" style="position:absolute; left:160px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio11-overlay" style="position:absolute; left:280px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio12-overlay" style="position:absolute; left:400px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio13-overlay" style="position:absolute; left:520px; width:121px; height:40px;">
                </div>
                ...
                <div id="{{id}}-radio14-overlay" style="position:absolute; left:640px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio15-overlay" style="position:absolute; left:760px; width:121px; height:40px;">
                </div>    
                ...
                <div id="{{id}}-radio16-overlay" style="position:absolute; left:880px; width:120px; height:40px;">
                </div>
            </div>
        </div>
    </div>    
    ...
    <a class="carousel-control-prev" style="width:36px; background-color:#333333; opacity:1;" href="#{{id}}-carousel-controls" role="button" data-slide="prev">
        <div style="position:absolute; border-radius: 6px 0 0 6px; color:white; width:40px; height:40px; border: 2px solid white;">
        </div>
    ...
    <a class="carousel-control-next" style="width:36px; background-color:#333333; opacity:1;" href="#{{id}}-carousel-controls" role="button" data-slide="next">
        <div style="position:absolute; border-radius: 0 6px 6px 0; color:white; width:40px; height:40px; border: 2px solid white;">
        </div>
