    ...
    <div class="carousel-inner">
        <div class="carousel-item">
            <div style="margin-left:44px; width:960px; height:40px; background-color: #333333;">
                <div id="{{id}}-radio1" class="form-check" style="position:absolute; left:40px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio2" class="form-check" style="position:absolute; left: {{offsets.[1]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio3" class="form-check" style="position:absolute; left: {{offsets.[2]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio4" class="form-check" style="position:absolute; left: {{offsets.[3]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio5" class="form-check" style="position:absolute; left: {{offsets.[4]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio6" class="form-check" style="position:absolute; left: {{offsets.[5]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio7" class="form-check" style="position:absolute; left: {{offsets.[6]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio8" class="form-check" style="position:absolute; left: {{offsets.[7]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
        ...
        <div class="carousel-item active">
            <div style="margin-left:44px; width:960px; height:40px; background-color: #333333;">
                <div id="{{id}}-radio9" class="form-check" style="position:absolute; left:40px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio10" class="form-check" style="position:absolute; left: {{offsets.[1]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio11" class="form-check" style="position:absolute; left: {{offsets.[2]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio12" class="form-check" style="position:absolute; left: {{offsets.[3]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio13" class="form-check" style="position:absolute; left: {{offsets.[4]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio14" class="form-check" style="position:absolute; left: {{offsets.[5]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio15" class="form-check" style="position:absolute; left: {{offsets.[6]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
                ...
                <div id="{{id}}-radio16" class="form-check" style="position:absolute; left: {{offsets.[7]}}px; color:white; width:{{buttonWidth}}px; height:40px; border: 2px solid white; padding-top:4px; padding-left: 28px; font-size:20px; font-family:sans-serif;">
