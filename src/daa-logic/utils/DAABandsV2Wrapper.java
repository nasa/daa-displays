...
public class DAABandsV2Wrapper extends DAABandsV2 {
	...
	public static void main(String[] args) {
		DAABandsV2Wrapper daaBands = new DAABandsV2Wrapper();
		...
		DaidalusWrapper wrapper = new DaidalusWrapper(daaBands.daa);
		daaBands.walkFile(wrapper);
	}
}